...
export default function NoteForm({ type = 'create', setEditnote, editNote }) {
    ...
    return (
        <form onSubmit={submit} >
            <textarea value={body} onChange={e => setBody(e.target.value)} className={`p-3 shadow-md border-2 bg-gray-50 w-full ${isDark ? 'text-black bg-dcard border-primary' : ''} `} name="" id="" cols="30" rows="5"></textarea>
